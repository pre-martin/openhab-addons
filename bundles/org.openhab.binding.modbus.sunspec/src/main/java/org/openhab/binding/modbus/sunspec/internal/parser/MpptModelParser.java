...
/**
 * Parses SunSpec "Multiple MPPT Inverter Extension Model" data into a MpptModelBlock
 *
...
public class MpptModelParser extends AbstractBaseParser implements SunspecParser<MpptModelBlock> {
    ...
    public MpptModelBlock parse(ModbusRegisterArray raw) {
        ...
        block.modelId = extractUInt16(raw, 0, SunSpecConstants.MPPT);
        ...
        for (int i = 0; i < count; i++) {
            ...
            moduleBlock.moduleIdString = ModbusBitUtilities.extractStringFromRegisters(raw, offset + 1, 8,
